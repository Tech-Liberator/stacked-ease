<template>
  <div
    class="w-16 h-full py-3 flex flex-col justify-between items-center bg-white border-r-2 border-gray-200 dark:bg-gray-800 dark:border-gray-700 text-gray-700 dark:text-white"
  >
    <div class="flex flex-col gap-5">
      <div class="hs-tooltip inline-block [--placement:right]">
        <NuxtLink to="/projects" type="button" class="hs-tooltip-toggle">
          <svg
      ...
      <div class="hs-tooltip inline-block [--placement:right]">
        <NuxtLink to="/environments" type="button" class="hs-tooltip-toggle">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            class="w-5 h-5"
      ...
      <div class="hs-tooltip inline-block [--placement:right]">
        <NuxtLink to="/apis" type="button" class="hs-tooltip-toggle">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            class="w-5 h-5"
    ...
    <div class="flex flex-col gap-5 justify-center items-center">
      ...
      <div class="hs-tooltip inline-block [--placement:right]">
        <NuxtLink to="/settings" type="button" class="hs-tooltip-toggle">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
